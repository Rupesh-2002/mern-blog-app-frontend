  ...
  return (
    ...
    <svg
      ...
      <section className="relative bg-dark-hard px-5">
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center max-w-6xl">
            ...
            <div className="w-3/4 mx-auto relative">
              ...
              <div className="w-full rounded-xl bg-white p-3 z-[1] relative">
                <img
                  src={images.Ctaimage}
                  alt="title"
                  className="rounded-xl w-full object-cover object-center h-auto md:h-52 lg:h-48 xl:h-60"
                />
                <div className="p-5">
